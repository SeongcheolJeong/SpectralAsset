...
| `P3-T022` | `P3` | `P2` | `planned` | Expand `road_furniture` with transit-stop and roadside service detail | additional furniture manifests, geometry, exports, and scene coverage | `P3-T016`, `P3-T021` | the generator ships transit-stop or roadside service-detail assets with clean exports and updated validation-scene placement |
