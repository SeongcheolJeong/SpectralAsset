...
| `P3-T020` | `P3` | `P2` | `planned` | Expand `road_surface` with rural-lane, dirt-track, and bridge-joint variants | additional surface manifests, geometry, exports, and scene coverage | `P3-T014`, `P3-T019` | the generator ships rural-lane, dirt-track, or bridge-joint surface variants with updated validation-scene placement and clean exports |
...
- follow-up `P3` expansion beyond the current road-furniture, road-marking, traffic-light support, sign-assembly, road-surface, follow-up signal-head, sign-variation, road-marking breadth, road-surface breadth, specialized signal-head, control-tail furniture, locale/weathering sign, specialized road-marking, and route/service wayfinding sign batches now shifts to broader `road_surface` follow-up breadth in [catalog-gap-review.md](catalog-gap-review.md)
