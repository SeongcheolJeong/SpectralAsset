...
| `P3-T023` | `P3` | `P2` | `planned` | Expand `road_marking` with boxed curbside/transit legends and colored surfacing panels | additional marking manifests, geometry, exports, and scene coverage | `P3-T018`, `P3-T022` | the generator ships boxed curbside or transit-lane legends plus colored lane/surfacing panels with updated validation-scene placement and clean exports |
