...
| `P3-T030` | `P3` | `P2` | `planned` | Expand `road_surface` with grade-separated ramp ties, median noses, and temporary work-zone composites | additional surface manifests, geometry, exports, and scene coverage | `P3-T025`, `P3-T029` | the generator ships grade-separated ramp-tie, median-nose, or temporary work-zone-composite surface assets with updated validation-scene placement and clean exports |
