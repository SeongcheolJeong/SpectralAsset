...
- follow-up `P3` expansion beyond the current road-furniture, road-marking, traffic-light support, sign-assembly, and road-surface batches now shifts to traffic-light follow-up breadth and sign-variation work in [catalog-gap-review.md](catalog-gap-review.md)
