...
- follow-up `P3` expansion beyond the current road-furniture, road-marking, traffic-light support, sign-assembly, road-surface, follow-up signal-head, sign-variation, road-marking breadth, road-surface breadth, specialized signal-head, and control-tail furniture batches now shifts to broader `traffic_sign` depth in [catalog-gap-review.md](catalog-gap-review.md)
