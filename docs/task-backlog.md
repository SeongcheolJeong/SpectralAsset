...
| `P3-T025` | `P3` | `P2` | `planned` | Expand `road_surface` with heavier construction staging, bridge approaches, and barrier/curb transition composites | additional surface manifests, geometry, exports, and scene coverage | `P3-T020`, `P3-T024` | the generator ships heavier construction staging, bridge-approach, or curb/barrier transition surface variants with updated validation-scene placement and clean exports |
