...
| `P3-T033` | `P3` | `P2` | `planned` | Expand `road_marking` with turn-pocket stencils, school-bus queue markings, and curbside arrows | additional marking manifests, geometry, exports, and scene coverage | `P3-T028`, `P3-T032` | the generator ships turn-pocket stencil, school-bus queue, or curbside-arrow marking assets with updated validation-scene placement and clean exports |
