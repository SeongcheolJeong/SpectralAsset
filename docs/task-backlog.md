...
| `P3-T005` | `P3` | `P1` | `planned` | Expand `road_marking` with directional and worn variants | additional marking manifests, geometry, and scene coverage | `P3-T003` | the generator ships arrows, edge lines, chevrons or merge markings, plus at least one worn marking variant with updated validation coverage |
| `P3-T006` | `P3` | `P1` | `planned` | Add traffic-light support geometry and cabinet context | backplates, mast-arm context, or cabinet support assets | `P3-T003` | traffic-light scenes can place support geometry explicitly instead of implying it only through poles |
...
- follow-up `P3` expansion beyond the first `road_furniture` batch remains queued behind `road_marking`, traffic-light support geometry, and sign-assembly depth in [catalog-gap-review.md](catalog-gap-review.md)
