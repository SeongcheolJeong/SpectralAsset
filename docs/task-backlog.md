...
| `P3-T015` | `P3` | `P2` | `planned` | Expand `traffic_light` with lane-control or rail-specific heads | additional specialized signal-head manifests, emissive profiles, geometry, exports, and scene coverage | `P3-T011`, `P3-T014` | the generator ships lane-control or rail-specific traffic-light assets with clean exports and updated validation-scene placement |
...
- follow-up `P3` expansion beyond the current road-furniture, road-marking, traffic-light support, sign-assembly, road-surface, follow-up signal-head, sign-variation, road-marking breadth, and road-surface breadth batches now shifts to specialized `traffic_light` heads in [catalog-gap-review.md](catalog-gap-review.md)
