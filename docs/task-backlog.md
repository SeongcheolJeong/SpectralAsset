...
| `P3-T021` | `P3` | `P2` | `planned` | Expand `traffic_light` with transit-priority and specialty arrow/control heads | additional specialized signal-head manifests, emissive profiles, geometry, exports, and scene coverage | `P3-T015`, `P3-T020` | the generator ships transit-priority or specialty arrow/control traffic-light assets with dedicated state maps, clean exports, and updated validation-scene placement |
