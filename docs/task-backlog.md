...
- follow-up `P3` expansion beyond the current road-furniture, road-marking, traffic-light support, sign-assembly, road-surface, follow-up signal-head, sign-variation, road-marking breadth, road-surface breadth, specialized signal-head, control-tail furniture, locale/weathering sign, specialized road-marking, route/service wayfinding sign, rural/bridge road-surface batches, transit-priority/specialty-control signal batch, transit-stop/service-detail furniture batch, curbside/transit colored-marking batch, route-shield/destination-stack sign batch, heavy construction/bridge-approach/curb-transition surface batch, pedestrian-hybrid/tram-specialty signal batch, curbside transit/loading-detail furniture batch, curb-color/conflict-zone marking batch, overhead-destination/locale-shield sign batch, ramp-tie/median-nose/work-zone-composite surface batch, rail-gate/controller-nuance signal batch, turn-pocket/school-queue/curbside-arrow marking batch, and roundabout-apron/retaining-wall/deeper-staging surface batch now shifts to broader `traffic_sign` specialty-assembly, localized-service-panel, and route-shield follow-up work in [catalog-gap-review.md](catalog-gap-review.md)
