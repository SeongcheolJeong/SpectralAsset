...
| `P3-T027` | `P3` | `P2` | `planned` | Expand `road_furniture` with bus-bay curb modules, passenger-information hardware, and deeper loading-zone detail | additional furniture manifests, geometry, exports, and scene coverage | `P3-T022`, `P3-T026` | the generator ships bus-bay curb, passenger-information, or loading-zone support-detail assets with clean exports and updated validation-scene placement |
