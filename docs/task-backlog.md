...
| `P3-T028` | `P3` | `P2` | `planned` | Expand `road_marking` with curb-color/loading delimiters and conflict-zone surfacing | additional marking manifests, materials, geometry, exports, and scene coverage | `P3-T023`, `P3-T027` | the generator ships curb-color/loading delimiter and conflict-zone surfacing assets with updated validation-scene placement and clean exports |
