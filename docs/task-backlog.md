...
- follow-up `P3` expansion beyond the current road-furniture and road-marking batches remains queued behind traffic-light support geometry, sign-assembly depth, and road-surface distress work in [catalog-gap-review.md](catalog-gap-review.md)
