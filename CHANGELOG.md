...
- backlog focus now moves from `traffic_light` rail-gate/controller-nuance follow-up to `road_furniture` queue-rail, shelter-panel, curb-ramp, and deeper attachment-hardware work after the latest signal batch
